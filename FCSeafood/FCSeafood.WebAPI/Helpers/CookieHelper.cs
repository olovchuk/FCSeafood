...
public class CookieHelper {
    private readonly ILogger _loggger = LoggerFactory.Create(b => { b.AddConsole(); }).CreateLogger(typeof(CookieHelper));
    ...
    public void SetCookie(string key, string value, TimeSpan expired, bool serverOnly) {
        var options = new CookieOptions {
            Expires = DateTime.Now.Add(expired), HttpOnly = serverOnly
        };
