...
export class AboutUsSection {
  ...
  constructor() {
    this.aboutCardsInfo = [
      ...
      {imgSrc: 'assets/icons/filled-info.svg', title: 'Convenience', text: 'Customers can easily access information about the seafood products they are interested in, including origin, catch method, and sustainability practices'},
